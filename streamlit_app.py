...
def generate_response(input_text, zhipuai_api_key):
    ...
    llm = ZhipuAILLM(model = "glm-4", temperature = 0.7, api_key = zhipuai_api_key)  #model="glm-4-0520", 
...
def get_chat_qa_chain(question:str,zhipuai_api_key:str):
    ...
    llm = ZhipuAILLM(model = "glm-4", temperature = 0, api_key = zhipuai_api_key)  #model="glm-4-0520", 
